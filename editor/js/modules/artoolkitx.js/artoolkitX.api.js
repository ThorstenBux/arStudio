...
export default class ARController {
  ...
  */
  ...
  [_prepareImage] (image) {
    ...
    /* Gray data for 2D trackable
        // FIX: implemente a better algorythm to convert to gray scale image
        // FIX: The buffer might be too large for gray scale as it is meant to hold color image
        const grayData = []
